...
## Overview
FastAPI-based URL shortener with SQLite, click tracking, and multi-format API responses.

## Purpose
Provides URL shortening with analytics and redirect tracking.
...
### Project Structure
```
app/main.py (FastAPI), app/routers/auth_router.py, app/routers/urls.py, app/models.py, app/auth.py, frontend/src/ (React 19 SPA), Dockerfile
```
